    ...
    public class DBInitializer
    {
        public static void Initialize(NewsContext context)
        {
            ...
            context.Users.AddRange(
                new User { UserID = 1, RoleID = 1, Username = "test1", Password = "test", FirstName = "Test", LastName = "Test", Email = "test.test@thomasmore.be" },
                new User { UserID = 2, RoleID = 2, Username = "davidvand", Password = "test", FirstName = "David", LastName = "Test", Email = "david.test@mail.be" },
                new User { UserID = 3, RoleID = 3, Username = "test3", Password = "test", FirstName = "Test", LastName = "Test", Email = "test.test@mail.be" }
